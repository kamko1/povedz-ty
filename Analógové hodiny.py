...
def kresli_hodiny():
    farba = f'#{random.randint(150, 256):02x}{random.randint(150, 256):02x}{random.randint(150, 256):02x}'
    pero.up()
    pero.setheading(0)
    pero.setpos(0, 0)
    pero.down()
...
def rucicky(hod, min):
    #hodinova
    pero.setpos(0, 0), pero.setheading(90-hodiny*30), pero.down(), pero.width(6), pero.forward(222)
    #minutova
